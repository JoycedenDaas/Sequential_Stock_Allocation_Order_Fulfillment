# -*- coding: utf-8 -*-
"""
Created on Fri Jan 27 12:46:11 2023
...
def gurobi_stock_CO2(order_id, sku_id, S_k, Warehouses, M_j, N_j, C_km_jk, E_km_jk,q,  D_in_cost,D_in_CO2, D_out, surface_i, weigth_dict,reduction,lim):
    model = gp.Model("stock_allo_CO2")
    ...
    model.setObjective(gp.quicksum(y[i,j]*D_in_CO2[i,j]  for j in Warehouses for i in sku_id )
                      + 
    ...
    print("CO2 optimal", model.objVal)
    ...
    # print("CO2 calculated", total_CO2 )
