# -*- coding: utf-8 -*-
"""
Created on Fri Jan 27 12:41:36 2023
...
def gurobi_stock_split(order_id, sku_id, S_k, Warehouses, M_j, N_j, C_km_jk, E_km_jk, q,  D_in_cost,D_in_CO2, D_out, surface_i, weigth_dict, reduction, lim):
    model = gp.Model("stock_allo_Split")
    ...
    model.setObjective(gp.quicksum(z[j,k] for j in Warehouses for k in   S_k.keys()))
    model.update()
    model.__data = x,y,z
    ...
    print("Split optimal", model.objVal)
